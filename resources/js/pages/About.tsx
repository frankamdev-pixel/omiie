...
export default function About() {
 ...
 const testimonials = [
  { quote: "OMIIE a transformé notre gestion IT. Fiable et abordable !", author: "Entreprise X, Yaoundé", rating: 5 },
  { quote: "Support exceptionnel, solutions sur mesure pour notre startup.", author: "TechHub Douala", rating: 5 },
  { quote: "Sécurité renforcée, productivité boostée. Recommandé !", author: "Banque Locale", rating: 4.5 }
 ];

 const timeline = [
  { year: "2018", event: "Fondation d'OMIIE à Yaoundé" },
  { year: "2020", event: "Lancement des services cloud locaux" },
  { year: "2022", event: "Partenariat avec 50+ PME camerounaises" },
  { year: "2024", event: "Expansion en Afrique Centrale" },
    ...
    <div className="max-w-5xl mx-auto text-center">
     ...
     <div className="grid md:grid-cols-3 gap-8 mb-12">
      ...
      <div className="flex items-center justify-center gap-3">
       ...
       <div>
        <p className="font-bold">contact@omiie.cm</p>

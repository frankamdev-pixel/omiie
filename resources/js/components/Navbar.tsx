...
import { useEffect, useRef, useState } from 'react';
import { route } from 'ziggy-js'; // ✅ Correct import Ziggy
...
export default function Navbar() {
    ...
    const menuLinks = [
        { name: 'Accueil', icon: <Home size={18} />, href: '/'},
        { name: 'Services', icon: <FolderOpen size={18} />, href: '/' },
        { name: 'À propos', icon: <Info size={18} />, href: 'about' },
        { name: 'Contact', icon: <Phone size={18} />, href: 'contact' },
    ];
    ...
    return (
        <nav className="fixed top-0 z-50 w-full bg-gradient-to-r from-pink-600 via-pink-500 to-pink-400 text-white shadow-lg">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
                {/* Logo */}
                <Link
                    href='/'
